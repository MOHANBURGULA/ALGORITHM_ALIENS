  ...
  return (
    <div className="max-w-[700px] mx-auto animate-fadeIn">
      ...
      <div className="bg-[#1f1b36] p-6 rounded-2xl space-y-4 border border-white/5 hover:shadow-2xl hover:shadow-[#6c5ce7]/10 transition-all duration-500 hover:border-[#6c5ce7]/20 group/profile relative overflow-hidden">
        ...
        <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-[#8b7cf6]/5 rounded-full blur-3xl group-hover/profile:scale-150 transition-transform duration-700"></div>
        ...
        <div className="flex items-center gap-4 mb-6 relative z-10">
          ...
          <div>
            ...
            <p className="text-xs text-[#8b7cf6] mt-1">HR Administrator</p>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between relative z-10">
        ...
        <div className="opacity-0 group-hover/field:opacity-100 transition-opacity duration-300">
          <span className="text-xs text-[#8b7cf6] flex items-center gap-1">
      ...
      <p className="font-semibold mt-1 group-hover/field:translate-x-2 transition-transform duration-300 relative z-10 break-all">
        {value}
      </p>

      {/* Bottom gradient line */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-transparent via-[#8b7cf6] to-transparent group-hover/field:w-3/4 transition-all duration-700"></div>
